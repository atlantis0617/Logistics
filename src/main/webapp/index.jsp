            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <a href="index.jsp" class="waves-effect waves-light active"><i class="md md-home"></i><span> Dashboard </span></a>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="email-compose.jsp">Compose Mail</a></li>
                                    <li><a href="email-read.jsp">View Mail</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="calendar.jsp" class="waves-effect"><i class="md md-event"></i><span> Calendar </span></a>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="checkbox-radio.jsp">Checkboxs-Radios</a></li>
                                    <li><a href="tabs-accordions.jsp">Tabs &amp; Accordions</a></li>
                                    <li><a href="modals.jsp">Modals</a></li>
                                    <li><a href="bootstrap-ui.jsp">BS Elements</a></li>
                                    <li><a href="progressbars.jsp">Progress Bars</a></li>
                                    <li><a href="notification.jsp">Notification</a></li>
                                    <li><a href="sweet-alert.jsp">Sweet-Alert</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="portlets.jsp">Portlets</a></li>
                                    <li><a href="widgets.jsp">Widgets</a></li>
                                    <li><a href="nestable-list.jsp">Nesteble</a></li>
                                    <li><a href="ui-sliders.jsp">Sliders </a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="material-icon.jsp">Material Design</a></li>
                                    <li><a href="ion-icons.jsp">Ion Icons</a></li>
                                    <li><a href="font-awesome.jsp">Font awesome</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="code-editor.jsp">Code Editors</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="morris-chart.jsp">Morris Chart</a></li>
                                    <li><a href="chartjs.jsp">Chartjs</a></li>
                                    <li><a href="flot-chart.jsp">Flot Chart</a></li>
                                    <li><a href="peity-chart.jsp">Peity Charts</a></li>
                                    <li><a href="charts-sparkline.jsp">Sparkline Charts</a></li>
                                    <li><a href="chart-radial.jsp">Radial charts</a></li>
                                    <li><a href="other-chart.jsp">Other Chart</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gmap.jsp"> Google Map</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="email-template.jsp">Email template</a></li>
                                    <li><a href="contact.jsp">Contact-list</a></li>
                                    <li><a href="login.jsp">Login</a></li>
                                    <li><a href="register.jsp">Register</a></li>
                                    <li><a href="recoverpw.jsp">Recover Password</a></li>
                                    ...
                                    <li><a href="404_alt.jsp">404 alt</a></li>
